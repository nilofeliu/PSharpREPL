...
{
    internal sealed class GreenCoalesceAssignmentExpression : GreenExpression, IAssignmentExpression
    {
        ...
        {
            var node = new GreenCoalesceAssignmentExpression(Kind, IdentifierToken, OperatorToken, Expression);
