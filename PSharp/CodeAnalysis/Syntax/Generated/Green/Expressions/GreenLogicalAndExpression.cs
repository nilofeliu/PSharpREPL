...
{
    internal sealed class GreenLogicalAndExpression : GreenExpression, ILogicalExpression
    {
        ...
        {
            var node = new GreenLogicalAndExpression(Kind, Left, OperatorToken, Right);
