...
{
    internal sealed class GreenGreaterThanExpression : GreenExpression, IComparisonExpression
    {
        ...
        {
            var node = new GreenGreaterThanExpression(Kind, Left, OperatorToken, Right);
