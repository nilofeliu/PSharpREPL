...
{
    internal sealed class GreenLessThanOrEqualExpression : GreenExpression, IComparisonExpression
    {
        ...
        {
            var node = new GreenLessThanOrEqualExpression(Kind, Left, OperatorToken, Right);
