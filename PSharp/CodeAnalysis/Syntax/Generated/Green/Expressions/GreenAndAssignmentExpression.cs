...
{
    internal sealed class GreenAndAssignmentExpression : GreenExpression, IAssignmentExpression
    {
        ...
        {
            var node = new GreenAndAssignmentExpression(Kind, IdentifierToken, OperatorToken, Expression);
