...
{
    internal sealed class GreenExclusiveOrAssignmentExpression : GreenExpression
    {
        public GreenToken IdentifierToken { get; }
        public GreenToken CaretEqualsToken { get; }
        ...
        {
            var node = new GreenExclusiveOrAssignmentExpression(Kind, IdentifierToken, CaretEqualsToken, Expression);
