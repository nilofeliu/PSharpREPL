...
{
    internal sealed class GreenSubtractAssignmentExpression : GreenExpression, IAssignmentExpression
    {
        ...
        {
            var node = new GreenSubtractAssignmentExpression(Kind, IdentifierToken, OperatorToken, Expression);
