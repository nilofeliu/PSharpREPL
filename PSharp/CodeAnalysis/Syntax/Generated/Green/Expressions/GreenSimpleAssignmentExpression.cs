...
{
    internal sealed class GreenSimpleAssignmentExpression : GreenExpression, IAssignmentExpression
    {
        ...
        {
            var node = new GreenSimpleAssignmentExpression(Kind, IdentifierToken, OperatorToken, Expression);
