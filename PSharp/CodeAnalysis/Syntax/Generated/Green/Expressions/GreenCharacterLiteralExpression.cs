...
{
    internal sealed class GreenCharacterLiteralExpression : GreenExpression, ILiteralExpression
    {
        ...
        {
            var node = new GreenCharacterLiteralExpression(Kind, LiteralToken);
