...
{
    internal sealed class GreenNotEqualsExpression : GreenExpression, IComparisonExpression
    {
        ...
        {
            var node = new GreenNotEqualsExpression(Kind, Left, OperatorToken, Right);
