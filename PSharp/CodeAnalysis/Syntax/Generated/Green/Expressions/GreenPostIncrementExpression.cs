...
{
    internal sealed class GreenPostIncrementExpression : GreenExpression, IUnaryExpression
    {
        ...
        {
            var node = new GreenPostIncrementExpression(Kind, OperatorToken, Operand);
