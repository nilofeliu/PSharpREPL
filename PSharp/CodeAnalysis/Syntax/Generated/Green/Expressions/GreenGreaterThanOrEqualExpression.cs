...
{
    internal sealed class GreenGreaterThanOrEqualExpression : GreenExpression, IComparisonExpression
    {
        ...
        {
            var node = new GreenGreaterThanOrEqualExpression(Kind, Left, OperatorToken, Right);
