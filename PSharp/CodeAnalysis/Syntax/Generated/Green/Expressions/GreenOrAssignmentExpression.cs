...
{
    internal sealed class GreenOrAssignmentExpression : GreenExpression, IAssignmentExpression
    {
        ...
        {
            var node = new GreenOrAssignmentExpression(Kind, IdentifierToken, OperatorToken, Expression);
