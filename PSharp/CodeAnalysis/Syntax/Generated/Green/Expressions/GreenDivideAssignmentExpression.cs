...
{
    internal sealed class GreenDivideAssignmentExpression : GreenExpression, IAssignmentExpression
    {
        ...
        {
            var node = new GreenDivideAssignmentExpression(Kind, IdentifierToken, OperatorToken, Expression);
