...
{
    public sealed class CoalesceAssignmentExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenCoalesceAssignmentExpression _green;

        private ExpressionSyntax _expression;

        internal CoalesceAssignmentExpressionSyntax(GreenCoalesceAssignmentExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken QuestionQuestionEqualsToken
            => new SyntaxToken(_green.QuestionQuestionEqualsToken, this, GetChildPosition(1));
