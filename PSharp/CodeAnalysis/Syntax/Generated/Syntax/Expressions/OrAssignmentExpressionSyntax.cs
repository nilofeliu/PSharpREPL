...
{
    public sealed class OrAssignmentExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenOrAssignmentExpression _green;

        private ExpressionSyntax _expression;

        internal OrAssignmentExpressionSyntax(GreenOrAssignmentExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken PipeEqualsToken
            => new SyntaxToken(_green.PipeEqualsToken, this, GetChildPosition(1));
