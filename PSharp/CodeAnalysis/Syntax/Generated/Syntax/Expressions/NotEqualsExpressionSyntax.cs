...
{
    public sealed class NotEqualsExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenNotEqualsExpression _green;

        private ExpressionSyntax _left;
        private ExpressionSyntax _right;

        internal NotEqualsExpressionSyntax(GreenNotEqualsExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken BangEqualsToken
            => new SyntaxToken(_green.BangEqualsToken, this, GetChildPosition(1));
