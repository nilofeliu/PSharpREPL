...
{
    public sealed class PreDecrementExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenPreDecrementExpression _green;

        private ExpressionSyntax _operand;

        internal PreDecrementExpressionSyntax(GreenPreDecrementExpression green, SyntaxNode? parent, int position)
