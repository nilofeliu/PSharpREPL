...
namespace PSharp.CodeAnalysis.Syntax.Nodes.Expressions
{
    ...
    {
        private readonly GreenLogicalNotExpression _green;

        private ExpressionSyntax _operand;

        internal LogicalNotExpressionSyntax(GreenLogicalNotExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken BangToken
            => new SyntaxToken(_green.BangToken, this, GetChildPosition(0));
