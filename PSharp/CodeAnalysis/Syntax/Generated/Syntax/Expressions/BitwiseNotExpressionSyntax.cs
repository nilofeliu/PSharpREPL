...
{
    public sealed class BitwiseNotExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenBitwiseNotExpression _green;

        private ExpressionSyntax _operand;

        internal BitwiseNotExpressionSyntax(GreenBitwiseNotExpression green, SyntaxNode? parent, int position)
