...
{
    public sealed class AddAssignmentExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenAddAssignmentExpression _green;

        private ExpressionSyntax _expression;

        internal AddAssignmentExpressionSyntax(GreenAddAssignmentExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken PlusEqualsToken
            => new SyntaxToken(_green.PlusEqualsToken, this, GetChildPosition(1));
