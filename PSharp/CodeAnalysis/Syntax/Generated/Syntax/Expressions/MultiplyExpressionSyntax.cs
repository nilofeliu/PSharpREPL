...
{
    public sealed class MultiplyExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenMultiplyExpression _green;

        private ExpressionSyntax _left;
        private ExpressionSyntax _right;

        internal MultiplyExpressionSyntax(GreenMultiplyExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken StarToken
            => new SyntaxToken(_green.StarToken, this, GetChildPosition(1));
