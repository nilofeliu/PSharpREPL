...
namespace PSharp.CodeAnalysis.Syntax.Nodes.Expressions
{
    ...
    {
        private readonly GreenLogicalOrExpression _green;

        private ExpressionSyntax _left;
        private ExpressionSyntax _right;

        internal LogicalOrExpressionSyntax(GreenLogicalOrExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken PipePipeToken
            => new SyntaxToken(_green.PipePipeToken, this, GetChildPosition(1));
