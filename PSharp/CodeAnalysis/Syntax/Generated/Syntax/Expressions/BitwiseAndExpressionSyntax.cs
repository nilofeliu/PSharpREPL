...
namespace PSharp.CodeAnalysis.Syntax.Nodes.Expressions
{
    ...
    {
        private readonly GreenBitwiseAndExpression _green;

        private ExpressionSyntax _left;
        private ExpressionSyntax _right;

        internal BitwiseAndExpressionSyntax(GreenBitwiseAndExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken AmpersandToken
            => new SyntaxToken(_green.AmpersandToken, this, GetChildPosition(1));
