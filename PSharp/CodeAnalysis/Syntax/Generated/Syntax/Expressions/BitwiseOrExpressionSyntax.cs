...
namespace PSharp.CodeAnalysis.Syntax.Nodes.Expressions
{
    ...
    {
        private readonly GreenBitwiseOrExpression _green;

        private ExpressionSyntax _left;
        private ExpressionSyntax _right;

        internal BitwiseOrExpressionSyntax(GreenBitwiseOrExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken PipeToken
            => new SyntaxToken(_green.PipeToken, this, GetChildPosition(1));
