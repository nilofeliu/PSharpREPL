...
namespace PSharp.CodeAnalysis.Syntax.Nodes.Expressions
{
    ...
    {
        private readonly GreenCoalesceExpression _green;

        private ExpressionSyntax _left;
        private ExpressionSyntax _right;

        internal CoalesceExpressionSyntax(GreenCoalesceExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken QuestionQuestionToken
            => new SyntaxToken(_green.QuestionQuestionToken, this, GetChildPosition(1));
