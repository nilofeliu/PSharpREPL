...
{
    public sealed class ExclusiveOrAssignmentExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenExclusiveOrAssignmentExpression _green;

        private ExpressionSyntax _expression;

        internal ExclusiveOrAssignmentExpressionSyntax(GreenExclusiveOrAssignmentExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken CaretEqualsToken
            => new SyntaxToken(_green.CaretEqualsToken, this, GetChildPosition(1));
