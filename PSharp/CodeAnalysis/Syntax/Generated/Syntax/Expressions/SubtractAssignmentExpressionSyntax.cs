...
{
    public sealed class SubtractAssignmentExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenSubtractAssignmentExpression _green;

        private ExpressionSyntax _expression;

        internal SubtractAssignmentExpressionSyntax(GreenSubtractAssignmentExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken MinusEqualsToken
            => new SyntaxToken(_green.MinusEqualsToken, this, GetChildPosition(1));
