...
namespace PSharp.CodeAnalysis.Syntax.Nodes.Expressions
{
    ...
    {
        private readonly GreenNumericLiteralExpression _green;

        internal NumericLiteralExpressionSyntax(GreenNumericLiteralExpression green, SyntaxNode? parent, int position)
