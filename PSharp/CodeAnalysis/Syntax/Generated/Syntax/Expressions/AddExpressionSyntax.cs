...
{
    public sealed class AddExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenAddExpression _green;

        private ExpressionSyntax _left;
        private ExpressionSyntax _right;

        internal AddExpressionSyntax(GreenAddExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken PlusToken
            => new SyntaxToken(_green.PlusToken, this, GetChildPosition(1));
