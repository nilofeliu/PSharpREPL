...
{
    public sealed class ModuloAssignmentExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenModuloAssignmentExpression _green;

        private ExpressionSyntax _expression;

        internal ModuloAssignmentExpressionSyntax(GreenModuloAssignmentExpression green, SyntaxNode? parent, int position)
