...
{
    public sealed class ExclusiveOrExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenExclusiveOrExpression _green;

        private ExpressionSyntax _left;
        private ExpressionSyntax _right;

        internal ExclusiveOrExpressionSyntax(GreenExclusiveOrExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken CaretToken
            => new SyntaxToken(_green.CaretToken, this, GetChildPosition(1));
