...
{
    public sealed class LessThanOrEqualExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenLessThanOrEqualExpression _green;

        private ExpressionSyntax _left;
        private ExpressionSyntax _right;

        internal LessThanOrEqualExpressionSyntax(GreenLessThanOrEqualExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken LessThanEqualsToken
            => new SyntaxToken(_green.LessThanEqualsToken, this, GetChildPosition(1));
