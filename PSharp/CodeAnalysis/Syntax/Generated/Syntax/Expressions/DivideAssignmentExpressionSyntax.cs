...
{
    public sealed class DivideAssignmentExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenDivideAssignmentExpression _green;

        private ExpressionSyntax _expression;

        internal DivideAssignmentExpressionSyntax(GreenDivideAssignmentExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken SlashEqualsToken
            => new SyntaxToken(_green.SlashEqualsToken, this, GetChildPosition(1));
