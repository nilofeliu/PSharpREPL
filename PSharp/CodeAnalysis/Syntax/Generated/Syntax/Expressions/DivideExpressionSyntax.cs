...
{
    public sealed class DivideExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenDivideExpression _green;

        private ExpressionSyntax _left;
        private ExpressionSyntax _right;

        internal DivideExpressionSyntax(GreenDivideExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken SlashToken
            => new SyntaxToken(_green.SlashToken, this, GetChildPosition(1));
