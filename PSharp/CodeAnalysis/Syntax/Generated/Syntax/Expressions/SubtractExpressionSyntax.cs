...
{
    public sealed class SubtractExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenSubtractExpression _green;

        private ExpressionSyntax _left;
        private ExpressionSyntax _right;

        internal SubtractExpressionSyntax(GreenSubtractExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken MinusToken
            => new SyntaxToken(_green.MinusToken, this, GetChildPosition(1));
