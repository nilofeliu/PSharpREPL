...
{
    public sealed class GreaterThanOrEqualExpressionSyntax : ExpressionSyntax
    {
        private readonly GreenGreaterThanOrEqualExpression _green;

        private ExpressionSyntax _left;
        private ExpressionSyntax _right;

        internal GreaterThanOrEqualExpressionSyntax(GreenGreaterThanOrEqualExpression green, SyntaxNode? parent, int position)
        ...
        public SyntaxToken GreaterThanEqualsToken
            => new SyntaxToken(_green.GreaterThanEqualsToken, this, GetChildPosition(1));
