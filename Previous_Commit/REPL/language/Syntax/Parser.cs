...
namespace REPL.language.Syntax
{
    internal sealed class Parser
    {
        ...
        private ExpressionSyntax ParseCommandExpression()
        {
            //var identifierToken = MatchToken(SyntaxKind.CommandExpression);

            var identifierToken = MatchToken(SyntaxKind.DispatchToken);

            return new DispatchExpressionSyntax(identifierToken);
        }
    }
}