...
public class LexerTests
{
    ...
    public void Lexer_Tests_AllTokens()
    {
        ...
        var testedTokenKinds = GetTokens().Concat(GetSeparator())
            .Select(t => t.kind)
            .Distinct()
            .ToList();
        ...
        untestedTokenKinds.Remove(SyntaxKind.BadCommandToken);
        untestedTokenKinds.Remove(SyntaxKind.CommandToken);
