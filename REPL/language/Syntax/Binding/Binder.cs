...
internal sealed class Binder
{
    ...
    public readonly Dictionary<VariableSymbol, object> _variables;
    ...
    public BoundExpression BindExpression(ExpressionSyntax syntax)
    {
        switch (syntax.Kind)
        {
            case SyntaxKind.DispatchExpression:                
                return BindDispatchExpression((DispatchExpressionSyntax)syntax);
    ...
    private BoundExpression BindDispatchExpression(DispatchExpressionSyntax syntax)
    {
        return new BoundCommandExpression(syntax.Expression);
    }
